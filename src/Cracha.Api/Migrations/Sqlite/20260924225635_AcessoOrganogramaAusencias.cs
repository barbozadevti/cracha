        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SolicitadaEm = table.Column<long>(type: "INTEGER", nullable: false),
                    SolicitadaPor = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    DecididaEm = table.Column<long>(type: "INTEGER", nullable: true),
                    DecididaPor = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    MotivoRecusa = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CriadoEm = table.Column<long>(type: "INTEGER", nullable: false),
                    UltimoAcesso = table.Column<long>(type: "INTEGER", nullable: true),
                    Carimbo = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false)
                },
                constraints: table =>
                {
